...
$fulladdr = $addrstreet . ' ' . $addrhousenumber . ', ' . $addrpostcode . ' ' . $addrcity;
$osakstreetno = ltrim($osakstreetno, '0');
$osakmunicipalityno = ltrim((int)$osakmunicipalityno, '0');
...
$sql .= "INSERT INTO osmadd (date,postnr,data) VALUES ('$dato','$postnummer','$sqltextexport');";
